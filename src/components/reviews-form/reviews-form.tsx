...
const ReviewsForm: FC = () => {
  ...
  const isSubmitButtonAnabled =
    comment.length >= Settings.MIN_COMMENT_LENGTH &&
    comment.length <= Settings.MAX_COMMENT_LENGTH &&
    rating !== null;
  ...
  return (
    ...
    >
      ...
      <div className="reviews__rating-form form__rating">
        {Array.from({ length: Settings.STAR_RATING_MAX }, (v, k) => k).map(
          (_, i) => {
      ...
      <div className="reviews__button-wrapper">
        <p className="reviews__help">
          ...
          <b className="reviews__text-amount">
            {Settings.MIN_COMMENT_LENGTH} characters
          </b>
          .
        </p>
        <button
